...
from meta_learn.random_gp import SparseRandomGPMeta, RandomGPPosterior
...
# this is going to be a sparse GP with variational inference

class SparseGPRegressionMetaLearnedVI(RegressionModelMetaLearned):
    ...
    def __init__(self, meta_train_data, num_iter_fit=10000, feature_dim=1,
                 ...
                 task_batch_size=-1, normalize_data=True, random_seed=None, num_inducing_points=5):
        """
    ...
    def _setup_model_inference(self, mean_module_str, covar_module_str, mean_nn_layers, kernel_nn_layers, cov_type):
        ...
        """ random gp model """
        self.random_gp = SparseRandomGPMeta(size_in=self.input_dim, prior_factor=self.prior_factor,
                                  ...
                                  mean_nn_layers=mean_nn_layers, kernel_nn_layers=kernel_nn_layers, num_inducing_points=self.num_inducing_points)
...
if __name__ == "__main__":
    ...
    for prior_factor in [1e-3 / 40.]:
        gp_model = SparseGPRegressionMetaLearnedVI(meta_train_data, num_iter_fit=2000, prior_factor=prior_factor, svi_batch_size=10, task_batch_size=2,
