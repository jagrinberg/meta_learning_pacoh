...
from meta_learn.random_gp import SparseRandomGPMeta
...
class SparseGPRegressionMetaLearnedSVGD(RegressionModelMetaLearned):
...
if __name__ == "__main__":
    ...
    for prior_factor in [1e-3]:
        gp_model = SparseGPRegressionMetaLearnedSVGD(meta_train_data, num_iter_fit=2000, prior_factor=prior_factor, num_particles=10,
